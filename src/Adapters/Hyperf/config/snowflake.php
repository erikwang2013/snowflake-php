...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    'clock_drift_strategy' => \Hyperf\Support\env('SNOWFLAKE_CLOCK_DRIFT_STRATEGY', 'throw'),
    ...
    |--------------------------------------------------------------------------
    */
    'clock_drift_wait_ms' => (int) (\Hyperf\Support\env('SNOWFLAKE_CLOCK_DRIFT_WAIT_MS', '1000')),
